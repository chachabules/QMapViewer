...
#include <memory>
#include "../mapwidget/TileLoader.h"
...
QT_MOC_LITERAL(1, 11, 12), // "signLoadTile"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 6), // "Tile<>"
QT_MOC_LITERAL(4, 32, 4) // "tile"

    },
    "TileLoader\0signLoadTile\0\0Tile<>\0tile"
};
...
void TileLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TileLoader::*)(Tile<> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TileLoader::signLoadTile)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TileLoader::signLoadTile(Tile<> _t1)
{
