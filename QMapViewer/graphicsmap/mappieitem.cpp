...
void MapPieItem::attach(MapObjectItem *obj)
{
    if(m_attachObj) {
        disconnect(m_attachObj, &MapObjectItem::coordinateChanged, this, &MapPieItem::setCoordinate);
        disconnect(m_attachObj, &MapObjectItem::rotationChanged, this, &MapPieItem::on_attachRotationChanged);
    }
    if(obj) {
        m_attachObj = obj;
        connect(m_attachObj, &MapObjectItem::coordinateChanged, this, &MapPieItem::setCoordinate);
        connect(m_attachObj, &MapObjectItem::rotationChanged, this, &MapPieItem::on_attachRotationChanged);
        setCoordinate(m_attachObj->coordinate());
    }

}

void MapPieItem::detach()
{
    if(m_attachObj) {
        disconnect(m_attachObj, &MapObjectItem::coordinateChanged, this, &MapPieItem::setCoordinate);
        disconnect(m_attachObj, &MapObjectItem::rotationChanged, this, &MapPieItem::on_attachRotationChanged);
...
void MapPieItem::on_attachRotationChanged(const qreal &degree)
{
    setAzimuth(degree);
    updatePie();
}
