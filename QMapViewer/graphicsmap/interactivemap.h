 ...
 * @note 通过该类管理的对象，不要手动从场景移除，请调用该类的删除接口
 */
 ...
 * @note 在多个事件处理函数中，如果返回true，表示事件已被处理不希望再被传递，反之false表示希望该事件继续被传递处理
 * 另外，一个鼠标事件周期包含两种：press release 和 doubleClick release
 * @todo 为了统计操作器的交互习惯，建议左键双击完成编辑、右键赋予具体的编辑功能
